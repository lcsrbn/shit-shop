  ...
  if (!cart.ready) {
    return (
      <main style={{ padding: 30, maxWidth: 960, margin: "0 auto" }}>
        <div style={{ padding: "40px 0", opacity: 0.6 }}>Caricamento checkout…</div>
      </main>
    );
  }
    ...
    return (
      <main style={{ padding: 30, maxWidth: 960, margin: "0 auto" }}>
        <div style={{ padding: "40px 0", opacity: 0.6 }}>
          Carrello vuoto — reindirizzamento…
        </div>
      </main>
    );
  }
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <div style={{ minWidth: 28, textAlign: "center", fontWeight: 950 }}>
                    {row.qty}
                  </div>
